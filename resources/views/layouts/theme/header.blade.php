        ...
        <ul class="navbar-item flex-row">
            <li class="nav-item theme-logo">
                <a href="index.html">
                    ...
                    <b style="font-size: 19px; color: #3b3f5c">Tienda de figuras</b>
                </a>
            </li>
        </ul>
        ...
        <ul class="navbar-item flex-row navbar-dropdown">
                            ...
                            <div class="">
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <div class="">
                                            <h5 class="usr-name">Kiara Silvestre</h5>
                                            <p class="msg-title">revisa el pedido 43543</p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <a class="dropdown-item">
                            <div class="">
                                <div class="media">
                                    <div class="user-img">
                                        <div class="avatar avatar-xl">
                                            <span class="avatar-title rounded-circle">JL</span>
                                        </div>
                                    </div>
                                    <div class="media-body">
                                        <div class="">
                                            <h5 class="usr-name">Jhony Linarez</h5>
                                            <p class="msg-title">se recibio bien el pedido</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <a class="dropdown-item">
                            <div class="">
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        <div class="">
                                            <h5 class="usr-name">Oscar Gil</h5>
                                            <p class="msg-title">salieron las ultimas secciones</p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="notification-scroll">
                        ...
                        <div class="dropdown-item">
                            <div class="media server-log">
                                ...
                                <div class="media-body">
                                    <div class="data-info">
                                        <h6 class="">Servidor reiniciara en 5 min</h6>
                        ...
                        <div class="dropdown-item">
                            <div class="media ">
                                ...
                                <div class="media-body">
                                    <div class="data-info">
                                        <h6 class="">La licencia de tu host expirará pronto</h6>
                                        <p class="">8 hrs ago</p>
                                    </div>
            ...
            <li class="nav-item dropdown user-profile-dropdown  order-lg-0 order-1">
                ...
                <div class="dropdown-menu position-absolute animated fadeInUp" aria-labelledby="userProfileDropdown">
                    ...
                    <div class="dropdown-item">
                        <a href="sobrebandai">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-lock"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"></rect><path d="M7 11V7a5 5 0 0 1 10 0v4"></path></svg> <span>Sobre BAN DAI</span>
                        </a>
                    </div>
                    <div class="dropdown-item">
                        <a href="{{url('welcome')}}">
